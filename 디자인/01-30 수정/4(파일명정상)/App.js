...
const WriteContent = () => {
  ...
  const handleImageChange = (e) => {
    ...
    saveImageLocally(file, imagepath, filename);
  };


const saveImageLocally = (file, path, filename) => {
  ...
  reader.onload = (event) => {
    ...
    // 파일 저장
    saveImageToFile(blob, path, filename);
  };
...
// Blob을 파일로 저장하는 함수
const saveImageToFile = (blob, path, filename) => {
