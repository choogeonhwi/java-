      ...
      다음 페이지
        ...
        <div className='cateTable'>
         <ul className='cate'><h1 className='catemain'>카테고리</h1>
            ...
            <li id="cate1" name="cate1" onClick={() => handleCateClick(1,"반려견자랑")}>반려견 자랑</li>
            <li id="cate2" name="cate2" onClick={() => handleCateClick(1,"동물병원추천")}>동물병원 추천</li>
            <li id="cate3" name="cate3" onClick={() => handleCateClick(1,"애견카페추천")}>애견카페 추천</li>
          </ul>
        </div>
      </div>
    </div>
